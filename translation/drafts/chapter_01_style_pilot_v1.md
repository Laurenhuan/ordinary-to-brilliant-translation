...
- `docs/STYLE_GUIDE.md`
- `docs/TERMINOLOGY_VERIFICATION_GUIDE.md`
- `glossary/chapter_01_candidates.csv`
- `qa/chapter_01_translation_review.md`
...
- `seodang` and named historical education settings;
- classical Chinese learning and classical book titles;
- culturally specific claims about education; and
- Joseon-period historical context.
